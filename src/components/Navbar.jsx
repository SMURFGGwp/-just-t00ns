...
export default function Navbar() {
  ...
  return (
    <nav
      className={`fixed z-50 border-on-surface bg-surface shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] flex justify-between items-center transition-all duration-300 navbar-transition ${scrolled ? 'px-md py-xs' : 'px-md py-sm'
        }`}
      style={navStyle}
    >
