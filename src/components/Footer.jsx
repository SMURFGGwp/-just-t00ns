...
export default function Footer() {
  ...
  const renderSocials = (isMobile = false) => (
    <div className={`flex items-center ${isMobile ? 'gap-2 scale-90' : 'gap-sm'}`}>
      <a
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Right Side: Title Logo and Social Media Links (Desktop Only) */}
        <div className="hidden md:flex flex-col items-center md:items-end gap-sm">
          <h2
      ...
      <div className="flex-grow min-h-[120px] md:min-h-[160px]" />

      {/* Bottom Copyright Bar */}
      <div
        className="w-full flex flex-col justify-between items-center gap-xs z-20 pb-xs md:pb-sm"
      >
        {/* Mobile Cluster (Tightly grouped columns below characters) */}
        <div className="md:hidden flex flex-col items-center gap-2 my-2 w-full">
          <h2
            className="font-h1 text-h1 text-[28px] tracking-wide"
            style={neoTextShadow}
          >
            JUST T00NS
          </h2>
          {renderSocials(true)}
          <p
            className="font-h3 text-lg mt-1"
            style={neoTextShadow}
          >
            © 2026 just t00ns
          </p>
        ...
        {/* Desktop-only copyright at bottom left */}
        <div 
          className="hidden md:flex w-full justify-between items-center"
          style={{
            paddingLeft: spacingStyles.paddingLeft,
            paddingRight: spacingStyles.paddingRight,
          }}
        >
          <p
